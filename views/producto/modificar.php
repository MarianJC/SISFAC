 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modificando Producto</h1>  
    </div>
    ...
    <div class="card-body shadow">
      ...
      <form method="post" action="?c=producto&a=actualizar">
        ...
        <div class="form-group">
            <input type="hidden" name="idprodu" value="<?php echo $datos['idproducto']; ?>">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="cosuni" step="0.01" value="<?php echo $datos['cosuni']; ?>">
          </div>
          <div class="form-group">
            <label for="precio">Precio Unitario</label>
            <input type="number" class="form-control" name="preuni" step="0.01" value="<?php echo $datos['preuni']; ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="categoria" >
             <option value="0">Seleccione Categoríaa</option> 
            <?php
