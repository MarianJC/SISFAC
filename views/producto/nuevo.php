 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Agregando Producto</h1>  
    </div>
    ...
    <div class="card-body shadow">
      <form method="post" action="?c=producto&a=guardar">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="cosuni" step="0.01" value="0.00" required>
          </div>
          <div class="form-group">
            <label for="precio">Precio Unitario</label>
            <input type="number" class="form-control" name="preuni" step="0.01" value="0.00" required>
          </div>
          <div class="form-group">
